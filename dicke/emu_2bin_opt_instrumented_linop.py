...
import dicke_collective_sparse_opt as dc  # Helper functions for initial states and observables
import numpy as np
from datetime import datetime
...
# Convert sparse initial state to dense for LinearOperator streaming
...
# Use LinearOperator-based streaming evolution
stream = dc_linop.evolve_times_stream(H, psi0, l_table, chunk=args.chunk, normalize=args.normalize)
# Compute observables from the stream
t_stream, Jz_t, dc_p_e = dc_linop.observables_from_stream(stream, Jz_list, S_list)
