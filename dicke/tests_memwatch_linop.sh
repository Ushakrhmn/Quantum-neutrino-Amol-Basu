...
: "${EMU_LOG:=logs/emu_linop_${SLURM_JOB_ID:-$$}.log}"
: "${EMU_MEMLOG:=logs/mem_linop_${SLURM_JOB_ID:-$$}.log}"
# ------------------------------------------
...
# CMD=(python -u emu_2bin_opt_instrumented_linop.py --e1 8000 --m2 8000 --j 0.000625 --chunk 1)
# CMD=(python emu_2bin_opt_instrumented_linop.py --j 2.5 --e1 2000 --m2 2000 --chunk 1)
CMD=(python emu_2bin_opt_instrumented_linop.py --j 2.5 --e1 4000 --m2 4000 --chunk 1)
log "Command: ${CMD[*]}"
