...
# run simulation    
sim = aer.AerSimulator(method = "matrix_product_state",precision="double", zero_threshold=1e-14, validation_threshold=1e-12)
...
plt.legend()
plt.savefig("nunu_16_interact.png")
